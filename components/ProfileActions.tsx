    ...
    return (
      <div className="flex gap-2 sm:gap-3">
        <button
          ...
          disabled={loading}
          className="px-6 sm:px-8 py-2.5 rounded-full font-bold transition-all shadow-sm min-h-[44px] text-sm border-2 border-slate-300 text-slate-700 hover:border-red-300 hover:text-red-600 hover:bg-red-50"
        >
          {loading ? '...' : 'Nebesekti'}
        </button>
      </div>
    ...
    return (
      <div className="flex gap-2 sm:gap-3">
        <button
          ...
          className="flex items-center gap-2 px-6 sm:px-8 py-2.5 rounded-full font-bold transition-all shadow-sm min-h-[44px] text-sm bg-slate-100 text-slate-600 hover:bg-red-50 hover:text-red-600"
        >
          <Clock size={16} />
